...
abstract class AppTextStyles {
  ...
  static  TextStyle semiBold32 (BuildContext context) => TextStyle(
    fontFamily: 'Poppins',
    fontWeight: FontWeight.w600,
  ...
  static  TextStyle semiBold36 (BuildContext context) => TextStyle(
    fontFamily: 'Poppins',
    fontWeight: FontWeight.w600,
  ...
  static  TextStyle bold26 (BuildContext context) => TextStyle(
    fontFamily: 'Poppins',
    fontWeight: FontWeight.bold,
    fontSize: getResponsiveFontSize(context, baseFontSize: 26),
    color: Colors.white
  );
